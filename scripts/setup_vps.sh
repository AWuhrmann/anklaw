...
echo ""
echo "  # Anki Agent — Claude Code agent mode (recommended)"
echo "  0 3 * * * cd $PROJECT_DIR && bash run_agent.sh >> logs/agent_run.log 2>&1"
echo ""
echo "  # Anki Agent — direct API mode (simpler, no web search)"
